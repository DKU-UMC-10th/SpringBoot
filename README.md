# SpringBoot Study Guide
단국대학교 UMC 10th SpringBoot_A팀 스터디 진행 가이드입니다.
...
# 미션 브랜치 생성 후 이동
git checkout -b mission/week03-hmooko

# 또는 실습 브랜치 생성 후 이동
git checkout -b practice/week03-hmooko
```
...
# 원격 브랜치로 푸시
git push -u origin mission/week03-hmooko
```
