...
public class MissionServiceImpl implements MissionService {
    ...
    @Override
    public MissionResDTO.MemberMissionPreviewList getMyMissionsFromBody(Long userId, MissionStatus status, Integer page, Integer size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<MemberMission> memberMissionPage = memberMissionRepository.findByMemberIdAndStatus(userId, status, pageable);
        return MissionConverter.toMemberMissionPreviewList(memberMissionPage);
    }
